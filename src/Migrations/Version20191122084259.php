 ...
 */
final class Version20191122084259 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD genre VARCHAR(55) NOT NULL COLLATE utf8mb4_unicode_ci, DROP genre_id');
    }
}
